...
<div class="caption">
  AcuLa aligns medical audio encoder representations with language representations from a frozen medical LLM (semantic teacher), while retaining acoustic detail via a self-supervised objective. 
</div>
